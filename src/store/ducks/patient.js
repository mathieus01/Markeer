export const Types = {
  ...
  PUT_PATIENT_REQUEST: 'patient/PUT_PATIENT_REQUEST',
  PUT_PATIENT_SUCCESS: 'patient/PUT_PATIENT_SUCCESS',
...
export default function patient(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case Types.PUT_PATIENT_REQUEST:
      return { ...state, loading: true };
    case Types.PUT_PATIENT_SUCCESS:
      return { ...state, loading: false };
...
export const Creators = {
  ...
  updatePatientRequest: (patient) => ({
    type: Types.PUT_PATIENT_REQUEST,
    payload: { patient },
  }),

  updatePatientSuccess: () => ({
    type: Types.PUT_PATIENT_SUCCESS,
  }),
