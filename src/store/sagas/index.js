...
import { getPatients, savePatient, getPatient, removePatient, updatePatient } from './patient';
import { getSurgery, getSurgeries, saveSurgery, updateSurgery, removeSurgery } from './surgery';
...
export default function* rootSaga() {
  yield all([
    ...
    takeLatest(PatientTypes.PUT_PATIENT_REQUEST, updatePatient),
